...
for(const dir of ['assets','components','guides','downloads','registry','new','Jev'])await cp(dir,'dist/'+dir,{recursive:true});
console.log(`Built Syntari 0.2.1: ${components.length} component pages, 8 guides, gallery, Jev experiment, and installable source archive.`);
