...
for(const file of ['index.html','library.html','gallery.html','landing.css','favicon.svg','docs.css','docs.js','docs-data.js','docs-guides.js','docs-gallery.js','preview.html','preview.js','preview.css',...runtime])await copyFile(file,'dist/'+file);
