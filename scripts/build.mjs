...
for(const dir of ['assets','components','guides','downloads','registry','new','Jev','art-atlas','tmp'])await cp(dir,'dist/'+dir,{recursive:true});
console.log(`Built Syntari ${version}: ${components.length} component pages, 8 guides, gallery, Jev experiment, Art Atlas prototype, and installable source archive.`);