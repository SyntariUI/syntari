# Orbit interaction and layout audit — 10 September 2026

This report records local verification of the revised Orbit source, documentation, and installation archive before publication. Figma generation remains paused; its source inventory has been refreshed.
...
| Form controls | Range inputs used browser-blue tracks, numeric buttons could become oval, and password content could overflow. | Reused Orbit range styling and fill behavior; fixed circular stepper sizing; constrained password input and visibility control; themed autofill. |
...
[Open the working table](https://giovanitier.github.io/orbit/components/simple-data-table/) · [Open the gallery](https://giovanitier.github.io/orbit/gallery.html)
